...
HD_PWD='C:/Users/Hanfu/OneDrive/EE2020/Lab/game/game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game.vdi -applog -m64 -messageDb vivado.pb -mode batch -source game.tcl -notrace
